...
def track_trajectories(trajectories, output_folder, filename):
    ...
    for i, trajectory_ele in enumerate(trajectories):
        ...
        plt.scatter(trajectory[-1:,0], trajectory[-1:,1], cmap='viridis')
...
def main():
    ...
    folder_path = '/home/zhoutong/dir_sda/betty/zt_mp_lib/data/raw_data/traj_png3/'
    input_path = '/home/zhoutong/dir_sda/betty/zt_mp_lib/data/raw_data/traj_png2/'
