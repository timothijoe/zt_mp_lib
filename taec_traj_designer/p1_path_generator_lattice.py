...
LATTICE_LIBRARY_PATH = PATH_LIBRARY_PATH + 'lattice/'
ensure_directory_exists(PATH_LIBRARY_PATH)
ensure_directory_exists(LATTICE_LIBRARY_PATH)
...
def lane_state_sampling_one_case(final_theta_degree, dd =20, show_animation = True):
    ...
    for table in result:
        ...
        refine_x = refine_x * 9.01 / accumulated_distance
        refine_y = refine_y * 9.01 / accumulated_distance
    ...
    for degree in degree_list:
        ...
        for path in path_list:
            if path is not None:
                ...
                path_dictionary[end_y_key] = path
                # path_dictionary[end_y_key] = {}
                # path_dictionary[end_y_key]['path'] = path
                # path_dictionary[end_y_key]['x'] = end_x
                # path_dictionary[end_y_key]['y'] = end_y
                # path_dictionary[end_y_key]['theta'] = end_theta
                # path_dictionary[end_y_key]['xlabel'] = end_x_key
        print('zt1')
