...
# def save_trajs_to_img_batch(args, origin_traj_lst, generate_traj_lst):
#     origin_traj_lst = origin_traj_lst[:12]
#     generate_traj_lst = generate_traj_lst[:12]
#     save_traj_to_img(args, origin_traj_lst, generate_traj_lst)

def save_trajs_to_img_batch(args, origin_traj_lst, generate_traj_lst):
    for i in range(0, origin_traj_lst.shape[0], 12):
        cur_origin_traj_lst = origin_traj_lst[i: i+ 12, :, :]
        cur_generate_traj_lst = generate_traj_lst[i: i+ 12, :, :]
        if cur_generate_traj_lst.shape[0] < 12:
            continue
...
def save_traj_to_img(args, origin_traj_lst, generate_traj_lst, file_path1 = None):
    ...
    fig11.plot(origin_traj[:,0], origin_traj[:,1], color='red', linewidth = 3, label=f"Trajectory {1}")
    fig11.plot(recon_traj[:,0], recon_traj[:,1], color='green', linewidth = 2, label=f"Trajectory {1}")
    
    origin_traj = origin_traj_lst[1]
    recon_traj = generate_traj_lst[1]
    fig12.plot(origin_traj[:,0], origin_traj[:,1], color='red', linewidth = 3, label=f"Trajectory {1}")
    fig12.plot(recon_traj[:,0], recon_traj[:,1], color='green', linewidth = 2, label=f"Trajectory {1}")

    origin_traj = origin_traj_lst[2]
    recon_traj = generate_traj_lst[2]
    fig13.plot(origin_traj[:,0], origin_traj[:,1], color='red', linewidth = 3, label=f"Trajectory {1}")
    fig13.plot(recon_traj[:,0], recon_traj[:,1], color='green', linewidth = 2, label=f"Trajectory {1}")

    origin_traj = origin_traj_lst[3]
    recon_traj = generate_traj_lst[3]
    fig14.plot(origin_traj[:,0], origin_traj[:,1], color='red', linewidth = 3, label=f"Trajectory {1}")
    fig14.plot(recon_traj[:,0], recon_traj[:,1], color='green', linewidth = 2, label=f"Trajectory {1}")
    
    origin_traj = origin_traj_lst[4]
    recon_traj = generate_traj_lst[4]
    fig21.plot(origin_traj[:,0], origin_traj[:,1], color='red', linewidth = 3, label=f"Trajectory {1}")
    fig21.plot(recon_traj[:,0], recon_traj[:,1], color='green', linewidth = 2, label=f"Trajectory {1}")
    
    origin_traj = origin_traj_lst[5]
    recon_traj = generate_traj_lst[5]
    fig22.plot(origin_traj[:,0], origin_traj[:,1], color='red', linewidth = 3, label=f"Trajectory {1}")
    fig22.plot(recon_traj[:,0], recon_traj[:,1], color='green', linewidth = 2, label=f"Trajectory {1}")

    origin_traj = origin_traj_lst[6]
    recon_traj = generate_traj_lst[6]
    fig23.plot(origin_traj[:,0], origin_traj[:,1], color='red', linewidth = 3, label=f"Trajectory {1}")
    fig23.plot(recon_traj[:,0], recon_traj[:,1], color='green', linewidth = 2, label=f"Trajectory {1}")
    
    origin_traj = origin_traj_lst[7]
    recon_traj = generate_traj_lst[7]
    fig24.plot(origin_traj[:,0], origin_traj[:,1], color='red', linewidth = 3, label=f"Trajectory {1}")
    fig24.plot(recon_traj[:,0], recon_traj[:,1], color='green', linewidth = 2, label=f"Trajectory {1}")
    origin_traj = origin_traj_lst[8]
    recon_traj = generate_traj_lst[8]
    fig31.plot(origin_traj[:,0], origin_traj[:,1], color='red', linewidth = 3, label=f"Trajectory {1}")
    fig31.plot(recon_traj[:,0], recon_traj[:,1], color='green', linewidth = 2, label=f"Trajectory {1}")
    origin_traj = origin_traj_lst[9]
    recon_traj = generate_traj_lst[9]
    fig32.plot(origin_traj[:,0], origin_traj[:,1], color='red', linewidth = 3, label=f"Trajectory {1}")
    fig32.plot(recon_traj[:,0], recon_traj[:,1], color='green', linewidth = 2, label=f"Trajectory {1}")
    origin_traj = origin_traj_lst[10]
    recon_traj = generate_traj_lst[10]
    fig33.plot(origin_traj[:,0], origin_traj[:,1], color='red', linewidth = 3, label=f"Trajectory {1}")
    fig33.plot(recon_traj[:,0], recon_traj[:,1], color='green', linewidth = 2, label=f"Trajectory {1}")
    origin_traj = origin_traj_lst[11]
    recon_traj = generate_traj_lst[11]
    fig34.plot(origin_traj[:,0], origin_traj[:,1], color='red', linewidth = 3, label=f"Trajectory {1}")
    fig34.plot(recon_traj[:,0], recon_traj[:,1], color='green', linewidth = 2, label=f"Trajectory {1}")
...
def generate_compact_traj(traj, init_state, traj_len=10, trajj_type=None):
    total_traj_len = traj_len + 1 
